...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <table id="memberData" class="table mt-5">
  <thead>
    <tr>
      <th scope="col">#</th>
        ...
        while($row=mysqli_fetch_assoc($query)){
            ...
            <tr>
                  ...
                  <td>
                    ...
                    <input type="hidden" name="Delete-member_id" value="<?php  echo $row["member_id"]; ?>">
                    <button type="submit" name="btn-delete-member" class="btn btn-danger">Delete</button>
                    </form>
                  </td>
            </tr>
            <?php
