...
<nav class="bg-white bg-light">
   ...
   <h1 class="text-center text-muted "><a href="" class="text-decoration-none">Open library</a> </h1> 
    ...
    <div class="logn-form">
        <div class="content">
            <h1 class="text-center"> UserRegister</h1> 
                    <?php
            ...
            <form action="code.php" method="POST">
                  ...
                  <label class="form-label" for="form2Example22">address</label>
                    <input type="text" id="form2Example22" name="address" class="form-control" />
                  </div>

                  <button class="btn btn-primary" type="submit" name="btn_Register_member">Register</button>
                  <!-- <button class="btn btn-warning"> Login</button> -->
                  <a href="MemberLogin.php"class="btn btn-warning">Login</a>
